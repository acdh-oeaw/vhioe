...
urlpatterns = [
    ...
    url(r'^bearbeiter/create/$', views.BearbeiterCreate.as_view(), name='bearbeiter_create'),
    url(r'^bearbeiter/edit/(?P<pk>[0-9]+)$', views.BearbeiterUpdate.as_view(), name='bearbeiter_edit'),
    url(r'^bearbeiter/delete/(?P<pk>[0-9]+)$', views.BearbeiterDelete.as_view(), name='bearbeiter_delete'),
    url(r'^bearbeiter/detail/(?P<pk>[0-9]+)$', views.BearbeiterDetailView.as_view(), name='bearbeiter_detail'),
